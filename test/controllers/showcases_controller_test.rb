...
class ShowcasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create showcase" do
    assert_difference("Showcase.count") do
      post showcases_url, params: { showcase: { date: @showcase.date, key: @showcase.key, location_id: @showcase.location_id, name: @showcase.name, order: @showcase.order, year: @showcase.year } }
    end
  ...
  test "should update showcase" do
    patch showcase_url(@showcase), params: { showcase: { date: @showcase.date, key: @showcase.key, location_id: @showcase.location_id, name: @showcase.name, order: @showcase.order, year: @showcase.year } }
