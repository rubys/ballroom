...
class HeatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create heat" do
    assert_difference("Heat.count") do
      post heats_url, params: { heat: { ballroom: @heat.ballroom, category: @heat.category, dance_id: @heat.dance_id, entry_id: @heat.entry_id, number: @heat.number, prev_number: @heat.prev_number } }
    end
  ...
  test "should update heat" do
    patch heat_url(@heat), params: { heat: { ballroom: @heat.ballroom, category: @heat.category, dance_id: @heat.dance_id, entry_id: @heat.entry_id, number: @heat.number, prev_number: @heat.prev_number } }
