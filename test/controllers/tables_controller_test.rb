...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference("Table.count") do
      post tables_url, params: { table: { col: @table.col, locked: @table.locked, number: @table.number, option_id: @table.option_id, row: @table.row, size: @table.size } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { col: @table.col, locked: @table.locked, number: @table.number, option_id: @table.option_id, row: @table.row, size: @table.size } }
