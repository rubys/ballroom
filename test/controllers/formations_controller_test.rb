...
class FormationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create formation" do
    assert_difference("Formation.count") do
      post formations_url, params: { formation: { on_floor: @formation.on_floor, person_id: @formation.person_id, solo_id: @formation.solo_id } }
    end
  ...
  test "should update formation" do
    patch formation_url(@formation), params: { formation: { on_floor: @formation.on_floor, person_id: @formation.person_id, solo_id: @formation.solo_id } }
